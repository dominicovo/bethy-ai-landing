...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/your-username/bethy-landing-page.git
   ```
...
This is the public marketing site for Bethy — pricing, product tour, solutions by audience (landlords, letting agents, property management companies), trust/security, and legal pages. It's a content layer only; the actual product lives in Bethy's separate dashboard and tenant apps.
