        ...
        <div className="relative z-10 mx-auto">
          <div className="bg-background-4 space-y-10 rounded-2xl p-2 pt-14 md:space-y-14 lg:space-y-18">
            <div className="space-y-3 text-center">
              ...
              <TextReveal delay={0.2}>
                <p className="font-inter-tight text-tagline-2 mx-auto max-w-[420px] font-normal text-white/50">
                  Access your account and continue building AI-driven solutions for your business.
                </p>
              </TextReveal>
            </div>
                    ...
                    <div className="relative z-10">
                      <fieldset className="mb-6 space-y-2">
                        ...
                        <input
                          ...
                          className="focus-within:border-stroke-3/10 bg-background-5 placeholder:text-tagline-3 text-tagline-3 border-stroke-3/25 w-full rounded-2xl border px-4.5 py-3 text-white/90 placeholder:text-white/50 focus-within:border focus-within:outline-none"
                          required
                      ...
                      <div>
                        <PrimarySubmitButton className="w-full">Log in</PrimarySubmitButton>
                      </div>
                    </div>
          ...
          <RevealAnimation delay={0.1} instant>
            <p className="text-tagline-3 pt-7 text-center font-normal text-white/90">
              ...
              <Link href="/sign-up" className="text-opai-blue hover:underline">
                Sign up
              </Link>
            </p>
          </RevealAnimation>
